...
<?php
	...
	JOIN tbl_plataformas AS p ON g.plataforma_id = p.id where status = true ORDER BY nome ASC LIMIT $inicio, $qnt_result_pg");
...
<nav aria-label="Navegação de página game-lista">
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="game-lista.php?pagina=1">Primeira</a></li>
	<?php for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
		if($pag_ant >= 1){ ?>
    <li class="page-item"><a class="page-link" href="game-lista.php?pagina=<?=$pag_ant?>"><?php echo $pag_ant ?></a></li>
	<?php } } ?>
	<li class="page-item active"><a class="page-link" href="#"><?php echo $pagina ?><span class="sr-only"></span></a>
    </li>
	<?php for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
		if($pag_dep <= $quantidade_pg){ ?>
    <li class="page-item"><a class="page-link" href="game-lista.php?pagina=<?=$pag_dep?>"><?php echo $pag_dep ?></a></li>
	<?php } } ?>
    <li class="page-item"><a class="page-link" href="game-lista.php?pagina=<?=$quantidade_pg?>">Última</a></li>
  </ul>
</nav>
